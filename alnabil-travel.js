        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alnabil/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-النبيل/عروض-جورجيا/عرض-جورجيا-1.jpg', 'عرض جورجيا - تبليسي & باتومي'],
    },

    {
        title: 'عروض سريلانكا',
        image_1: ['عروض-شركة-النبيل/عروض-سريلانكا/عرض-سريلانكا-1.jpg', 'كاندي & بنتوتة & كولومبو'],
    },

    {
        title: 'عروض مصر',
        image_1: ['عروض-شركة-النبيل/عروض-مصر/عرض-مصر-1.jpg', 'عرض مصر - القاهرة & العين الساخنة'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-النبيل/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'سيلانجور & جزيرة لنكاوي & كوالالمبور'],
        image_2: ['عروض-شركة-النبيل/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'سيلانجور & لنكاوي & كوالالمبور'],
    },

    {
        title: 'عروض سنغافورة',
        image_1: ['عروض-شركة-النبيل/عروض-سنغافورة/عرض-سنغافورة-1.jpg', 'عرض سنغافورة - 4 ليالي'],
        image_2: ['عروض-شركة-النبيل/عروض-سنغافورة/عرض-سنغافورة-2.jpg', 'عرض سنغافورة - 5 ليالي'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-النبيل/عروض-تايلاند/عرض-تايلاند-1.jpg', 'عرض تايلاند - جزيرة بوكيت & بانكوك'],
        image_2: ['عروض-شركة-النبيل/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض تايلاند - بانكوك & بوكيت'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-النبيل/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'بونشاك & بالي & جاكرتا'],
        image_2: ['عروض-شركة-النبيل/عروض-اندونيسيا/عرض-اندونيسيا-2.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
        image_3: ['عروض-شركة-النبيل/عروض-اندونيسيا/عرض-اندونيسيا-3.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-النبيل/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - باكو & قبالا'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966576070900?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alnabiltravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة النبيل على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة النبيل على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة النبيل على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة النبيل للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة النبيل للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة النبيل`;
            img.title = `مكتب سياحي - شركة النبيل`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966576070900";
